...
const routes = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            component: () =>
              import(
                /* webpackChunkName : "product" */ "./views/app/pages/services"
              ),
            ...
            children: [
              ...
              // },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "product" */ "./views/app/pages/services/SavingsApplication"
                  )
              },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "product" */ "./views/app/pages/services/CarAquisitionLoan"
                  )
              },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "product" */ "./views/app/pages/services/CreditLoanApplication"
                  )
              }
            ]
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/profile/Settings"
                  )
              }
            ]
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName : "profile" */ "./views/app/pages/monitors"
              ),
            ...
            children: [
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/monitors/LoanMonitor"
                  )
              },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/monitors/SavingsMonitor"
                  )
              },
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/monitors/TransactionsMonitor"
                  )
              }
            ]
          },
      ...
      },
      {
        path: "/404",
        name: "404",
        component: () => import("./components/payo/Errors/NotFound-404")
      }
    ]
  },
  {
