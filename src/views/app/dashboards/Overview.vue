<template>
  <div>
          ...
          <b-card-body>
            <div class="float-left float-none-xs">
              <div class="d-inline-block">
                <h5 class="d-inline">Loan Statistics</h5>
    ...
    <b-row>
      <b-colxx style="min-width: 100%" xl="4" lg="6" md="12" class="mb-4">
        <b-card class="mb-4" :title="'Loan Borrowed / Amount Paid'">
