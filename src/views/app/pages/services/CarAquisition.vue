      ...
      <div class="form-side">
        ...
        <b-form @submit.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
          ...
          <b-card style="margin-top: 20px" class="w-100 mx-auto">
            ...
            <h6 class="mt-4">
              Please Note: The Cooperative Society has the right to impond the Vehicle purchased in the event of non-compliance with above stated condition of repayment on the scheme
            </h6>
          </b-card>
        </b-form>
      </div>
