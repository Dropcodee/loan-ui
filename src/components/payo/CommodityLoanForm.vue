      ...
      >
        ...
        <b-form-group label="Staff ID Number" class="has-float-label mb-4">
          ...
          <div v-if="$v.form.staffId.$error">
            <span v-if="!$v.form.staffId.required" class="error-text"
              >Please complete your profile to fill this details</span
            >
          </div>
        </b-form-group>
        ...
        <b-form-group label="Nature Of Item(s)" class="has-float-label mb-4">
          ...
          <div v-if="$v.form.nature.$error">
            <span v-if="!$v.form.nature.required" class="error-text"
        ...
        <b-form-group label="Loan Amount" class="has-float-label mb-4">
          ...
          <div v-if="$v.form.amount.$error">
            <span v-if="!$v.form.amount.required" class="error-text"
              >Please enter your loan requst amount</span
            >
            <span v-if="!$v.form.amount.minLength" class="error-text"
              >Sorry can't request for a loan less than is 10,000</span
            >
            <span v-if="!$v.form.amount.maxLength" class="error-text"
              >Sorry here is your current maximum loan request amount
              {{ $v.form.amount.$params.maxLength.max }}, please not that this
              amount is based on your current savings for the past 3
              months.</span
            >
            <span v-if="!$v.form.amount.numeric" class="error-text"
            ...
            >
              ...
              <div v-if="$v.form.tenure.$error">
                <span v-if="!$v.form.tenure.required" class="error-text"
                  >Please lets know how long it will take you to repay your loan
                  thanks.</span
                >
              </div>
            </b-form-group>
