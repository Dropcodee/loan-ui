<template>
  <b-colxx xxs="12" lg="6" xl="6" class="col-right">
    <single-lightbox
      :thumb="user.avatar"
      :large="user.avatar"
    ...
    <b-card class="mb-4" no-body>
      <b-card-body>
        ...
        <b-row>
          ...
          <b-colxx>
            <p class="preview preview__text">
              {{ previewData.staffId || previewData.staff_id }}
              <span
        ...
        <b-row>
          ...
          <b-colxx>
            <p class="preview preview__text">
              {{ previewData.asset_nature ? previewData.asset_nature : 'N/A' }}
              <span
                class="preview__title"
              >Nature of Asset</span>
            </p>
          </b-colxx>
        </b-row>
        <b-row>
          <b-colxx>
            <p class="preview preview__text">
              {{ previewData.car_brand ? previewData.car_brand : 'N/A' }}
              <span
                class="preview__title"
              >Brand of Asset</span>
            </p>
          ...
          <b-colxx>
            <p class="preview preview__text" v-show="previewAmount">
              {{ previewAmount | toCurrency }}
              <span class="preview__title">Salary</span>
            </p>
            <p class="preview preview__text" v-show="!previewAmount">
              N/A
              <span class="preview__title">Salary</span>
        ...
        <b-row>
          <b-colxx v-show="previewData.displayDate">
            <p class="preview preview__text">
              {{ previewData.displayDate ? previewData.displayDate : 'N/A' }}
              <span
                class="preview__title"
              >Loan Commencement Date</span>
            </p>
          </b-colxx>
        </b-row>
      </b-card-body>
